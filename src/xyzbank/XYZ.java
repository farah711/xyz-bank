...
public class XYZ {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("/html/body/div/div/div[2]/div/div[2]/div/div/form/div[2]/input")).sendKeys("Mahmoud");
		
		driver.findElement(By.xpath("/html/body/div/div/div[2]/div/div[2]/div/div/form/div[3]/input")).sendKeys("711a");
		...
		WebElement element= driver.findElement(By.xpath("//*[@id=\"userSelect\"]"));
		 Select option = new Select(element);
			option.selectByVisibleText("Farah Mahmoud");
